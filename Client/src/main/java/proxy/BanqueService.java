...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "converstionEuroToDh", targetNamespace = "http://ws/", className = "proxy.ConverstionEuroToDh")
    @ResponseWrapper(localName = "converstionEuroToDhResponse", targetNamespace = "http://ws/", className = "proxy.ConverstionEuroToDhResponse")
    @Action(input = "http://ws/BanqueService/converstionEuroToDhRequest", output = "http://ws/BanqueService/converstionEuroToDhResponse")
